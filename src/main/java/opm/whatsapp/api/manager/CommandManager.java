...
import opm.whatsapp.features.command.commands.*;
import opm.whatsapp.features.command.commands.*;
...
public class CommandManager
    ...
    private String clientMessage = ChatFormatting.BOLD.toString() + ChatFormatting.DARK_RED + WhatsApp.MODNAME1
                                 + ChatFormatting.BOLD + ChatFormatting.GRAY + WhatsApp.MODNAME2; //idk why isnt it bold i will try to fix it later
