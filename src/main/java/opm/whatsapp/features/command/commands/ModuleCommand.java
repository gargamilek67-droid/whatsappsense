...
import opm.whatsapp.api.manager.ConfigManager;
...
public class ModuleCommand
    ...
    public void execute(String[] commands) {
        ...
        if (commands.length == 1) {
            ...
            for (Module.Category category : WhatsApp.moduleManager.getCategories()) {
                String modules = category.getName() + ": ";
                for (Module module1 : WhatsApp.moduleManager.getModulesByCategory(category)) {
        ...
        Module module = WhatsApp.moduleManager.getModuleByDisplayName(commands[0]);
        if (module == null) {
            module = WhatsApp.moduleManager.getModuleByName(commands[0]);
            if (module == null) {
