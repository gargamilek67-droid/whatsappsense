package opm.whatsapp.features.gui.components;
...
import opm.whatsapp.features.gui.components.items.buttons.Button;
...
public class Component
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        WhatsApp.textManager.drawStringWithShadow(this.getName(), (float) this.x + 3.0f, (float) this.y - 4.0f - (float) LuftwaffeGui.getClickGui().getTextOffset(), -1);
        if (this.open) {
