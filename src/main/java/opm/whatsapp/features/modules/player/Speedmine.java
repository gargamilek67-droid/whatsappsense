...
public class Speedmine
    ...
    public void onRender3D(Render3DEvent event) {
        if (this.render.getValue().booleanValue() && this.currentPos != null && this.currentBlockState.getBlock() == Blocks.OBSIDIAN) {
            Color color = new Color(this.timer.passedMs((int) (2000.0f * WhatsApp.serverManager.getTpsFactor())) ? 0 : 255, this.timer.passedMs((int) (2000.0f * WhatsApp.serverManager.getTpsFactor())) ? 255 : 0, 0, 255);
