...
import static opm.whatsapp.features.gui.components.Component.counter1;

public class Welcomer extends Module {
    private static Welcomer INSTANCE = new Welcomer();
    String hiMsg = "Wassup ";
    String nameMsg = "%name%";
    String welcomeMsg = " welcome to whatsapp :')";
    int white = 0xFFFFFFFF;

    public enum modes {Custom, Default}

    Setting<modes> mode = register(new Setting("ColorScheme", modes.Default));
    public Setting<String> text = register(new Setting("Text", "Welcome to whatsapp, %name%"));
