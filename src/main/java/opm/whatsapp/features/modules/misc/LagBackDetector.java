...
public class LagBackDetector extends Module {
    ...
    private void checkLagBack(Vec3d currentPos) {
        ...
        if (distance > 0.5) { // Пороговое значение
            Command.sendMessage("\"\" + ChatFormatting.DARK_RED + ChatFormatting.BOLD + \"\" + ChatFormatting.GRAY + ChatFormatting.BOLD + \".xyz\" +  \" \" + ChatFormatting.DARK_GREEN + \"Detected Lagback\": " + String.format("%.2f", distance));
            wasMoving = false;
            ticksStill = 0;
        }
    }
