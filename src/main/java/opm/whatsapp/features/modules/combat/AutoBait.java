            ...
            if (Msg.contains("<" + this.targetPlayer.getValue().toLowerCase() + ">")) {
                ...
                if (Msg.contains("i'm not") || Msg.contains("im not")) {
                    ...
                    sendMsg(
                            ...
                            "u talking to me?",
                            "no whatsapp no speak nn",
                            "Mark Zuckerberg said ur unkown LEL!",
                            "just do /r next time :pray:",
                            "tatrabanka dupe",
                            "Project more LEL",
                    ...
                    sendMsg(
                            ...
                            mc.player.getName(),
                            "this nigga XDDDDDDDD",
                            "LOOOOOOOOL im more known than that bald ngg FitMC"
                    );
                }
                    ...
                    mc.player.sendChatMessage("whatsapp is so good we love whatsapp");
                }
