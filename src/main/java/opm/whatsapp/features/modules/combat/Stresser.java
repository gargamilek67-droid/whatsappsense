...
import opm.whatsapp.api.event.events.TotemPopEvent;
...
public class Stresser extends Module {
    ...
    public Stresser() {
        super("Stresser", "totaly lags the fuck out of your opp", Category.COMBAT, true, false, false);
    }

    @SubscribeEvent
    public void onTotemPop(TotemPopEvent event) {
        if (!WhatsApp.friendManager.isFriend(event.getEntity())) {
