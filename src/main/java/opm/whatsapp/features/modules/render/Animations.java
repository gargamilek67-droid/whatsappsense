package opm.whatsapp.features.modules.render;

import opm.whatsapp.features.modules.Module;
import opm.whatsapp.features.setting.Setting;

import static opm.whatsapp.api.wrapper.IMinecraft.mc;
...
public class Animations extends Module {
    ...
    public Animations() {
        super("Animations", "Can slow down yo swing or speed up", Module.Category.RENDER, false, false, false);
        this.setInstance();
    }
